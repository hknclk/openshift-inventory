...
public interface InventoryApi {
    ...
    @ApiOperation(value = "", nickname = "inventoryGet", notes = "Should return all elements as an array of InventoryItems or an empty array if there are none.", response = InventoryItem.class, responseContainer = "List", tags={  })
    @ApiResponses(value = { 
...
// Prometheus metric
  ...
  // <<< Prometheus metric 
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Will return a specific inventory item", response = InventoryItem.class),
